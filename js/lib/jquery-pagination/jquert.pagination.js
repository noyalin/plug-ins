    ...
    $.fn[pluginName] = function (options) {
        ...
        var pagination = {
            ...
            observer: function () {
                ...
                // Go button click
                el.delegate('.J-paginationjs-go-button', 'click', function (e) {
                    e = e || event;
                    var pageNumber = $('.J-paginationjs-go-pagenumber', el).val();

                    // Before Go button clicked
                    if (self.callHook('beforeGoButtonOnClick', e, pageNumber) === false) return false;

                    container.trigger(eventPrefix + 'go', pageNumber);

                    // After Go button clicked
                    self.callHook('afterGoButtonOnClick', e, pageNumber);
                });
